...
source('server_functions/functions.R', local=T)
source('server_functions/Mode.R', local=T)
source('server_functions/process_data_for_aggregation.R', local=T)
source('server_functions/aggregate_data.R', local=T)
source('server_functions/format.R', local=T)
source('server_functions/utils.R', local=T)
source('server_functions/si_functions.R', local=T)
...
params$selected_questions <- params$selected_questions[3:5]
...
```{r faster area plots, results='asis', eval=T, include=T}
# library(data.table)
...
```{r generate_indicator_plots old,  results='asis', echo=F, eval=T, message=F, include=T}
...
```{r generate_indicator_plots,  results='asis', echo=F, eval=T, message=F, include=T}
# Generate plots for Section 2: By Indicator
# cat("\n# By Indicator2 {#indicator}\n")
