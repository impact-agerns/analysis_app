...
getwd()
library(pacman)
p_load(tidyverse, here, lubridate, janitor, httr, jsonlite, openxlsx, readxl, jmv, skimr, fuzzyjoin, zoo, broom, psych, epiR, hrbrthemes, rcompanion, knitr, stringr, KoboconnectR, robotoolbox, tidylog, viridis, RColorBrewer, impactR.analysis, srvyr, spdep, sp, ggcorrplot, ggridges, dplyr, kableExtra)
```
...
if (local){
  ...
  data_index <- read_excel(list.files(output_path, pattern="severity_index", full.names = T), sheet="Raw data") %>% 
